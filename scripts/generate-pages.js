...
<body class="bg-brand-darker text-slate-300 pt-20">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-24 items-center">
                ...
                <div class="md:hidden flex items-center">
                    <button class="mobile-menu-button outline-none" id="mobile-menu-btn">
        ...
        <div class="hidden mobile-menu md:hidden bg-slate-900 border-t border-white/5 pb-8 overflow-y-auto max-h-screen" id="mobile-menu">
            <ul class="pt-4">
                ...
                <li class="border-b border-white/5">
                    <button id="mobile-services-btn" class="w-full flex justify-between items-center text-lg px-6 py-4 text-white font-bold">
                        Áreas de Atuação
    ...
    <a href="https://wa.me/5531998955912?text=Preciso%20falar%20com%20um%20advogado%20criminalista%20agora." target="_blank" rel="noopener noreferrer" class="btn-whatsapp-float fixed bottom-6 right-6 bg-green-500 text-white rounded-full p-4 shadow-2xl hover:bg-green-600 transition-colors z-50 flex items-center justify-center">
...
<body class="bg-brand-darker text-slate-300 pt-20">
    ...
    <footer class="bg-black pt-24 pb-12 text-slate-600 border-t border-white/5 relative overflow-hidden">
        <div class="max-w-4xl mx-auto px-4 text-center">
            ...
            <div class="flex flex-wrap justify-center gap-6 text-[10px] mb-8 font-black uppercase tracking-[0.2em] text-slate-700">
